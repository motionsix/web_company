  ...
  return (
    <section id="contact" className="relative bg-base-200/50 text-base-content py-20 md:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-px bg-linear-to-r from-transparent via-secondary/30 to-transparent" />
      </div>
      ...
      <div className="relative mx-auto max-w-4xl px-4 md:px-8 z-10">
        ...
        <div className="text-center mb-12 md:mb-16">
          <span className="inline-block text-xs montserrat-500 tracking-[0.2em] uppercase text-secondary mb-3">
            {tx.contact.subtitle[lang]}
          </span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl montserrat-700 text-base-content">
            {tx.contact.titlePrefix[lang]} <span className="text-secondary">{tx.contact.titleHighlight[lang]}</span>
          </h2>
          <div className="mt-4 h-1 w-16 md:w-20 bg-linear-to-r from-secondary to-secondary/30 mx-auto rounded-full" />
        </div>

        {/* Contact card */}
        <div className="relative rounded-2xl border border-base-content/5 bg-base-100/60 backdrop-blur-sm p-5 md:p-7 shadow-xl shadow-black/5">
          <div className="absolute -top-px left-8 right-8 h-px bg-linear-to-r from-transparent via-secondary/40 to-transparent" />

          <h3 className="text-sm md:text-base montserrat-600 text-secondary mb-4 text-center tracking-widest uppercase">
            {tx.contact.getInTouch[lang]}
          </h3>

          <div className="space-y-1 montserrat-300 text-xs md:text-sm max-w-md mx-auto">
            {/* Email */}
            <a
              href="mailto:motionsixstudio@gmail.com"
              className="flex items-center gap-3 p-2.5 rounded-xl hover:bg-base-content/5 transition-all duration-300 group"
            >
              <div className="w-8 h-8 rounded-lg bg-secondary/10 flex items-center justify-center group-hover:bg-secondary/20 transition-colors shrink-0">
            ...
            >
              ...
              <span className="group-hover:text-secondary transition-colors">
                (+66)80-363-9043 <span className="montserrat-400 text-base-content/40 text-xs">(Strange)</span>
              </span>
            </a>
            ...
            >
              ...
              <span className="group-hover:text-secondary transition-colors">
                (+66)92-634-4491 <span className="montserrat-400 text-base-content/40 text-xs">(M)</span>
              </span>
            </a>
            ...
            >
              ...
              <span className="group-hover:text-secondary transition-colors">
                (+66)98-965-3536 <span className="montserrat-400 text-base-content/40 text-xs">(Yorch)</span>
              </span>
            </a>
          </div>
