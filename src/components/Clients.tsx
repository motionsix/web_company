  ...
  return (
    <section className="relative bg-base-200/50 py-20 md:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute -top-40 left-1/4 w-80 h-80 bg-accent/5 rounded-full blur-[120px]" />
        <div className="absolute -bottom-40 right-1/4 w-80 h-80 bg-info/5 rounded-full blur-[120px]" />
      </div>

      <div className="relative mx-auto max-w-7xl px-4 z-10">
        {/* Section header */}
        <div className="text-center mb-12 md:mb-16">
          <span className="inline-block text-xs montserrat-500 tracking-[0.2em] uppercase text-accent mb-3">We Work With</span>
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.parentElement!.innerHTML = `<span class="text-xs text-base-content/50 montserrat-400 text-center">${client.name}</span>`;
                    }}
                  />
                </div>
              </button>
